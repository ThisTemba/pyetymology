import wikt_api, etyobjects
from tests import test_

import networkx as nx

from tests.assets import asset_prototype
...
def test_graph_eq():
    ...
    assert (
        repr(dl)
        == "{prototype#English$0: [], $0{der|French|prototype}: [prototype#English$0], $0{der|Late Latin|prototypon}: "
